...
const nav = [
  ...
  { name: "Manual Behavior", href: "/manual-behavior", icon: UserX },
  { name: "Blocked", href: "/blocked", icon: Ban },
  { name: "Market", href: "/market", icon: TrendingUp },
  { name: "Scan Test", href: "/scan-test", icon: Zap },
  ...
  return (
    <div className={cn("min-h-screen bg-slate-900 flex", themeClass)}>
      ...
      <div className={cn("flex-1 flex flex-col min-h-screen transition-all duration-300", sidebarCollapsed ? "ml-16" : "ml-64")}>
        <header className="flex-shrink-0 sticky top-0 z-40 bg-slate-900/95 backdrop-blur-sm border-b border-slate-700/50">
