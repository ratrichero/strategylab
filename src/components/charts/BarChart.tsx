...
export function BarChart({
  ...
  const getBarColor = (value: number) => {
    ...
    return value >= 50 ? '#10b981' : value >= 40 ? '#f59e0b' : '#ef4444';
  };
      ...
      <div className={className}>
        <ResponsiveContainer width="100%" height={height}>
          <RechartsBarChart data={data} layout="vertical" margin={{ top: 10, right: 30, left: 80, bottom: 0 }}>
            ...
            <YAxis type="category" dataKey={xKey} stroke="#64748b" fontSize={12} tickLine={false} axisLine={false} width={70} />
            ...
            {yKey2 && <Bar dataKey={yKey2} fill="#10b981" radius={[0, 4, 4, 0]} />}
          </RechartsBarChart>
        </ResponsiveContainer>
      </div>
    );
