...
export function EdgeDiscovery() {
  ...
  return (
    <div className="space-y-6">
      ...
      {kpi && <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
      ...
      <TabContent>
        ...
        {tab==='feature'&&(<div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card><CardHeader title="MTF x Direction" />{ad.edge_mtf_direction?.length>0?<DataTable columns={[{key:'mtf_bucket',header:'MTF'},{key:'direction',header:'Dir',sortable:true},{key:'total',header:'N',sortable:true,align:'right'},RR_COL]} data={ad.edge_mtf_direction} pageSize={10} />:<div className="h-32 flex items-center justify-center text-slate-500">No data</div>}</Card>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {tab==='setup'&&(<div className="space-y-6">
          ...
          <Card><CardHeader title="Top Signal Combinations" subtitle="Pattern x Direction x TF" />{ad.edge_top_combo?.length>0?<DataTable columns={[{key:'pattern',header:'Pattern',sortable:true},{key:'direction',header:'Dir'},{key:'timeframe',header:'TF'},{key:'total',header:'N',sortable:true,align:'right'},RR_COL]} data={ad.edge_top_combo} pageSize={15} />:<div className="h-32 flex items-center justify-center text-slate-500">No data</div>}</Card>
          <Card><CardHeader title="Regime x Pattern" />{ad.edge_regime_pattern?.length>0?<DataTable columns={[{key:'regime',header:'Regime',sortable:true},{key:'pattern',header:'Pattern',sortable:true},{key:'total',header:'N',sortable:true,align:'right'},RR_COL]} data={ad.edge_regime_pattern} pageSize={15} />:<div className="h-32 flex items-center justify-center text-slate-500">No data</div>}</Card>
        </div>)}
