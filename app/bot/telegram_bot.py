...
def run_bot(token: str):
    ...
    updater.bot.set_my_commands([
        ...
        BotCommand("trades",        "📋 Lệnh đang mở / đang chờ"),
        BotCommand("performance",   "📈 Hiệu suất giao dịch"),
        BotCommand("filter",        "🎯 Bộ lọc lệnh"),
        BotCommand("config",        "⚙️ Cấu hình runtime"),
        BotCommand("set",           "📝 Cập nhật cấu hình"),
        BotCommand("mode",          "🔄 Chế độ trading"),
        BotCommand("strategies",    "🧩 Danh sách strategy"),
        BotCommand("cancel_pending","🚫 Hủy lệnh chờ"),
        BotCommand("retrain",       "🤖 Retrain ML"),
        BotCommand("report",        "📊 Báo cáo ngày/tuần/tháng"),
        BotCommand("agent",         "🧠 Báo cáo agent"),
        BotCommand("ml",            "🤖 Trạng thái ML"),
    ])
